                                ...
                                <div class="col-md-5 d-flex align-items-center">
                                    <div class="card-body py-5 px-4 p-md-5">
                                        ...
                                        <form action="logincode.php" method="post">
                                            ...
                                            <hr>
                                            <a class="link float-end" href="#!" style="color: #d12e11;">Forgot password</a><br>
                                            <a class="link float-end" href="userregistration.php" style="color: #d12e11;">Signup As User</a><br>
                                            <a class="link float-end" href="panditregistration.php" style="color: #d12e11;">Signup As Pojari</a>
